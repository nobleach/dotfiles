...
call s:h("TabLineSel",    { "fg": s:white,  "bg": s:warmgrey, })
...
call s:h("@keyword.coroutine.typescript", { "fg": s:aqua })
...
" Diagnostics
call s:h("DiagnosticError",            { "fg": s:red, "bg": s:lightblack3, "format": "" })
call s:h("DiagnosticWarn",             { "fg": s:orange, "bg": s:lightblack3, "format": "" })
call s:h("DiagnosticInfo",             { "fg": s:aqua, "bg": s:lightblack3, "format": "" })
