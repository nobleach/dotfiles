...
-- No borders when rearranging only 1 non-floating or maximithunarzed client
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "e",
    function ()
        awful.util.spawn(string.format("nautilus"))
	end,
    {description = "show file explorer", group = "hotkeys"}),
